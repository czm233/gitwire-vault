...
| 项目 | 本轮 | 状态 | 同步到 | 摘要 |
| --- | --- | --- | --- | --- |
| [RailtownAI-railtracks](./RailtownAI-railtracks) | 增量 | 已发布 | 75c3b17 | Middleware 泛型第三参数致 Python 3.11+ guardrails 导入失败，75c3b17 显式绑定 constraint 修复；#1583 全面改写 agent-facing 文档与技能文案。 |
